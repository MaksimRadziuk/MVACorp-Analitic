...
$(document).ready(function(){
    $(".close-cookies").click(function() {
        $('.cookie-branch').hide();
        $('.topPart').css('minHeight', ('calc(100vh - 90px)'))
    });
    if ($(".cookie-branch").length) {
        $('.topPart').css("minHeight", "calc(100vh - 130px)");     
    }
    else {
        $('.topPart').css("minHeight", "calc(100vh - 90px)");
    }
...
$(document).ready(function(){
    $('.changeHight').click(function() {
        $(this).prev('.higher').toggleClass('makeHigher');
...
$(document).ready(function(){
    $('.tab-link').click(function() {
        $(this).next('.mobile-table-box').slideToggle();
    });
});